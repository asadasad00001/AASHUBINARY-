...
# Bot Configuration
TELEGRAM_BOT_TOKEN = '7698308538:AAHMjK7rnF2h68tj61vOXMfr02T5AzwNiCQ'  # Replace with your bot token
OWNER_USERNAME = "AashuZodYt"  # Replace with your Telegram username (without @)
DEFAULT_GROUP_ID = -1002643293106  # Default group ID
...
async def attack_start(update: Update, context: CallbackContext):
    ...
    await update.message.reply_text("⚠️ *Select Attack button: <ip> <port> <duration>*", parse_mode='Markdown')
